% ============================================================
%  On the Alignment Between Marginal Uncertainty
%  Measures and Conditional Decision Risk
% ============================================================
...
\title{On the Alignment Between Marginal Uncertainty Measures and Conditional Decision Risk in Estimator Selection}
...
\]
where the probability is over both the training sample and a random test point $X$. This definition ensures that misselection probability vanishes asymptotically uniformly over $\mathcal{P}$; it is stronger than per-instance consistency and is the appropriate benchmark for comparing the structural limitations of marginal functionals against conditional decision targets.
...
Simulation code and experimental configurations are available at \url{https://github.com/wyp629929/estimator-selection-nl}. Real datasets: Home Credit Default Risk (Kaggle), PIMA Diabetes (UCI), and Superconductivity (UCI).

\paragraph{AI/LLM usage disclosure.}
Large language models (Claude, Anthropic) were used to assist with code development, experimental configuration, and manuscript preparation, including language refinement and structural organization. The author retains full accountability for the final version of this work.
