...
\textbf{AI/LLM usage disclosure:} Large language models (Claude, Anthropic) were used to assist with code development, experimental configuration, and manuscript preparation, including language refinement and structural organization. All intellectual contributions, analysis, and final editorial decisions are the sole responsibility of the author. The author retains full accountability for the work.
