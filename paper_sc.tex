...
\textbf{AI/LLM usage disclosure:} Large language models (Claude, Anthropic) were used to assist with code writing and experimental implementation, and to refine the wording of theoretical statements and proofs. All intellectual contributions, analysis, and final editorial decisions are the sole responsibility of the author. The author retains full accountability for the work.
